...
using DSSAlternative.Web.Models;
using DSSAlternative.Web.Shared.Components;
using DSSAlternative.Web.Shared.Components.EditorComponents.Hierarchy;
...
namespace DSSAlternative.Web.Shared
{
    public static class CssExtensions
    {
        ...
        public static ICssList WithCss(this ComponentBase component)
        {
            return new CssList();
        }
        ...
        private const string ColorUnknown = "#e9eb1d";
        private const string ColorUnconsistent = "#ff4d3d";
        ...
        public static (char symbol, string tooltip) Symbol(this IRelationNode relation)
        {
            if (relation.Unknown)
            {
                return ('?', "Отношение неизвестно");
            }
            if (!relation.CriteriaContext.Consistent)
            {
                return ('X', "Отношение несогласовано!");
            }
            return ('✓', "Отношение известно");
        }
