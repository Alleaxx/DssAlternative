...
namespace DSSAlternative.AHP
{
    public static class AhpExtensions
    {
        ...
        //{
        //    return project.HierarchyActive.Best(node.Level).Contains(node);
        //}
        ...
        {
            return project.Relations[node].Mtx.Cr; //project.ProblemActive.GetMtxRelations(node).Cr;
        }
